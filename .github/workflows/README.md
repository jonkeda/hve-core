...
| `artifacts/instructions/markdown.instructions.md`       | Markdown style guide         | All markdown workflows      |
| `artifacts/instructions/commit-message.instructions.md` | Commit message standards     | All workflows (informative) |
